...
const RecipientName = styled.div`
  ...
  color: ${({ $hasBackgroundImage }) => ($hasBackgroundImage ? "var(--white)" : "var(--gray-900)")};
  flex: none;
  align-self: stretch;
  flex-grow: 0;
...
const MessageCount = styled.div`
  ...
  line-height: 26px;
  letter-spacing: -0.01em;
  color: ${({ $hasBackgroundImage }) => ($hasBackgroundImage ? "var(--gray-200)" : "var(--gray-700)")};
  flex: none;
  flex-grow: 0;
...
const CardContent = ({ id, recipientName, messageCount, backgroundImageURL, backgroundColor, profileImage = [], handleCardClick, recipient }) => {
  return (
    <Card onClick={handleCardClick} backgroundColor={backgroundColor} backgroundImageURL={backgroundImageURL}>
      ...
      <Container>
        ...
        <ProfileImagesWrap>
          ...
          {messageCount > 3 && <ExtraProfiles>+{messageCount - 3}</ExtraProfiles>}
        </ProfileImagesWrap>
